...
#     model.to(device)
#     test_texts1 = ['餐厅位于北京路震庄宾馆，这家餐厅比较独特，开在宾馆内部，显得又神秘又高档，要去的话需要提前预定。我们点了一些招牌菜，比如天麻汽锅鸡，还有一个炸猪排也很好吃。考野生鲈鱼是现做现烤的，味道很鲜美。环境非常好，这个宾馆以前是国家元首居住的，在城中心，但是价格不便宜。',
...
#     star_lis1 = np.array([2.4, 2.1, 1.2, 2.25, 1.8])
#     test_texts = ['麒麟大口茶是新兴茶饮，只专注于一款产品，那就是糯米柠檬茶。我认为这款产品确实能够担当得起这家店的招牌产品，口味清新独特，有糯米风味和柠檬清香。价格来说不是很贵，是合理范围内的，并且量也很足，性价比是偏中上的。美中不足的是，店面只有一名员工，出餐效率偏低。',
...
#     star_lis = np.array([2.12, 2.78, 2.17, 1.98, 2.82])
